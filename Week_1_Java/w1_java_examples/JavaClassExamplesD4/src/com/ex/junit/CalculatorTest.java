...
//	 */
	...
	public void multiplicationOfZeroShouldReturnZero() {
		...
		//assertEquals( Message , Expected Value, Test Method Returns Actual Value)
		assertEquals("10 * 0 should return 0", 1, tester.multiply(10, 0));
...
//	 */
	...
	public void xyzMethodShouldThrowIllegalArgumentException() {
		System.out.println("Currently testing xyzMethodShouldThrow IllegalArgumentException");
